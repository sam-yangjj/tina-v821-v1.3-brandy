		       ...
		       int vid_hdr_offset, int max_beb_per1024)
{
	...
	/* Reserve 5% space for bad block processing(greater than or equal to 1) */
	if (!strcmp(mtd->name, "private_ubidev"))
		max_beb_per1024 = CONFIG_SUNXI_PRIVATE_UBIDEV_BLKS * 5 / 100;
	if (!max_beb_per1024)
		max_beb_per1024 = 1;
#endif
