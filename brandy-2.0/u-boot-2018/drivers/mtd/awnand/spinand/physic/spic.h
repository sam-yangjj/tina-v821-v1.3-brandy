...
#define SPI0_CLK_RST_REG		(0x02c0)
#define SPI0_CLK_GATINE_REG		(0x0060)
#define SPI0_CLK_RST_SHIFT		(20)
#define SPI0_CLK_GATINE_SHIFT	(20)

#elif defined(CONFIG_MACH_SUN300IW1)
#define	SPI0_CLK_REG			(0x001C)
#define SPI0_CLK_RST_REG		(0x0094)
#define SPI0_CLK_GATINE_REG		(0x0084)
#define SPI0_CLK_RST_SHIFT		(4)
#define SPI0_CLK_GATINE_SHIFT	(4)

#elif defined(CONFIG_MACH_SUN251IW1)
#define SPI0_CLK_RST_REG		(0x096c)
#define SPI0_CLK_GATINE_REG		(0x096c)
#define SPI0_CLK_RST_SHIFT		(16)
#define SPI0_CLK_GATINE_SHIFT	(0)
