		...
		struct aw_spinand_chip_request *req)
{
	...
	case BAD_BLK_FLAG_LAST_2_PAGE:
		...
		break;
	case BAD_BLK_FLAG_FIRST_2_PAGE_LAST_1_PAGE:
		/*
		 * the bad block flag is in the first page or the second page
		 * or the last page, so, need read the first page and the
		 * second page and the last page
		 */
		page_addr[1] = 1;
		page_addr[2] = pinfo->PageCntPerBlk - 1;
		break;
	default:
		break;
	}
