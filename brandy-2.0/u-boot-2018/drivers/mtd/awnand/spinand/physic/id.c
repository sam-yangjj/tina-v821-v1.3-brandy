...
struct aw_spinand_phy_info xtx[] =
{
	...
	},
	{
		/* XT26G01D */
		.Model		= "XT26G01D",
		.NandID		= {0x0B, 0x31, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		.DieCntPerChip  = 1,
		.SectCntPerPage = 4,
		.PageCntPerBlk  = 64,
		.BlkCntPerDie	= 1024,
...
struct aw_spinand_phy_info etron[] =
{
	{
		.Model  =       "EM73D044VCO",
		.NandID =       {0xd5, 0x3a, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		.DieCntPerChip  =       1,
		.SectCntPerPage =       4,
		.PageCntPerBlk  =       64,
		.BlkCntPerDie   =       2048,
...
struct aw_spinand_phy_info heyangtek[] = {
	...
	},
	{
		...
		.ecc_status_shift = ECC_STATUS_SHIFT_4,
		.EccProtectedType = SIZE16_OFF0_LEN16,
		.BadBlockFlag = BAD_BLK_FLAG_FIRST_2_PAGE_LAST_1_PAGE,
	},
	{
		.Model		= "HYF4GQ4UAACBE",
	...
	{
		.Model = "HYF2GQ4UAACAE",
		.NandID = {0xC9, 0x52, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		.DieCntPerChip = 1,
		.SectCntPerPage = 4,
		.PageCntPerBlk = 64,
		.BlkCntPerDie = 2048,
		.OobSizePerPage = 64,
		.OperationOpt = SPINAND_DUAL_READ | SPINAND_QUAD_READ | SPINAND_QUAD_PROGRAM,
		.MaxEraseTimes = 100000,
		.ecc_status_shift = ECC_STATUS_SHIFT_4,
		.EccType = BIT2_LIMIT1_ERR2_LIMIT3,
		.EccProtectedType = SIZE16_OFF4_LEN12,
