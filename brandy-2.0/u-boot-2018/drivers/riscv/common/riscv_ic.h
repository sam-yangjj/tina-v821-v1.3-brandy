...
#define ADDR_TPYE	u32
#define RISCV_STATUS_STR	"allwinner,sun8iw20-riscv"
#define RISCV_GPIO_INT_STR	"allwinner,sun8iw20-riscv-gpio-int"
#define RISCV_UART_STR		"allwinner,sun8iw20-riscv-uart"
#define RISCV_SHARE_SPACE	"allwinner,sun8iw20-riscv-share-space"
#elif defined(CONFIG_MACH_SUN300IW1)
#include "../sun300iw1/platform.h"
#define ADDR_TPYE	u32
#define RISCV_STATUS_STR	"allwinner,sun300iw1-riscv"
#define RISCV_GPIO_INT_STR	"allwinner,sun300iw1-riscv-gpio-int"
#define RISCV_UART_STR		"allwinner,sun300iw1-riscv-uart"
#define RISCV_SHARE_SPACE	"allwinner,sun300iw1-riscv-share-space"
#endif
#endif
