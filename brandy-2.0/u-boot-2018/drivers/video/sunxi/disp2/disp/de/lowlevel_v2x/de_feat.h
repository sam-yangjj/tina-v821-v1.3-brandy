...
#define VI_CHN_NUM	1
#define UI_CHN_NUM	(CHN_NUM - VI_CHN_NUM)
#define LAYER_NUM_PER_CHN_PER_VI_CHN	1
#define LAYER_NUM_PER_CHN_PER_UI_CHN	4
#define LAYER_MAX_NUM_PER_CHN 4 // maybe fixme

#define HAVE_DEVICE_COMMON_MODULE
#define HAVE_TCON_BUS_RESET_CLK // ahb_decoder use
#define HAVE_DISPLAY_SYS_TOP_CLK
