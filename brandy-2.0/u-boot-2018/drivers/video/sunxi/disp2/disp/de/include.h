...
typedef struct {
	...
	unsigned int            lcd_hv_de_polarity;
	...
	unsigned int lvds0_lane_np_inv;
	unsigned int lvds1_lane_np_inv;
	unsigned int lvds_even_odd_dir;
} disp_panel_para;
...
typedef enum {
	...
	DISP_MOD_DE_AHB,
	DISP_MOD_DISP_SYS_AHB,
	DISP_MOD_DISP_SYS_MBUS,
#endif
