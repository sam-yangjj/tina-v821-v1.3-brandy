...
static const int sun300iw1_de_num_chns[] = {
	/* DISP0 */
	2,
};

static const int sun300iw1_de_num_vi_chns[] = {
	/* DISP0 */
	1,
};

static const int sun300iw1_de_num_layers[] = {
	/* DISP0 CH0 */
	1,
	/* DISP0 CH1 */
	4,
...
static const int sun300iw1_de_is_support_vep[] = {
	/* DISP0 CH0 */
	0,
};

static const int sun300iw1_de_is_support_smbl[] = {
	/* DISP0 */
	0,
};

static const int sun300iw1_de_supported_output_types[] = {
	/* tcon0 */
	DE_OUTPUT_TYPE_LCD,
};

static const int sun300iw1_de_is_support_wb[] = {
	/* DISP0 */
	1,
};

static const int sun300iw1_de_is_support_scale[] = {
	/* DISP0 CH0 */
	1,
	/* DISP0 CH1 */
	0,
...
static const int sun300iw1_de_scale_line_buffer[] = {
	/* DISP0 */
	1280,
	/* DISP0 */
	0,
...
static const struct de_feat sun300iw1_de_features = {
	.num_screens = DE_NUM,
	.num_devices = DEVICE_NUM,
	.num_chns = sun300iw1_de_num_chns,
	.num_vi_chns = sun300iw1_de_num_vi_chns,
	.num_layers = sun300iw1_de_num_layers,
	.is_support_vep = sun300iw1_de_is_support_vep,
	.is_support_smbl = sun300iw1_de_is_support_smbl,
	.is_support_wb = sun300iw1_de_is_support_wb,
	.supported_output_types = sun300iw1_de_supported_output_types,
	.is_support_scale = sun300iw1_de_is_support_scale,
	.scale_line_buffer_yuv = sun300iw1_de_scale_line_buffer,
	.scale_line_buffer_rgb = sun300iw1_de_scale_line_buffer,
	.scale_line_buffer_ed = sun300iw1_de_scale_line_buffer,
};
#endif /* CONFIG_MACH_SUN300IW1 */
...
int de_feat_init(void)
{
	...
	de_cur_features = &sun300iw1_de_features;
#else
