...
#ifdef CONFIG_RISCV
	sunxi_soc_chipid[0] = readl((void *)(SUNXI_SID_BASE + 0x200));
	sunxi_soc_chipid[1] = readl((void *)(SUNXI_SID_BASE + 0x200 + 0x4));
	sunxi_soc_chipid[2] = readl((void *)(SUNXI_SID_BASE + 0x200 + 0x8));
	sunxi_soc_chipid[3] = readl((void *)(SUNXI_SID_BASE + 0x200 + 0xc));
#else
