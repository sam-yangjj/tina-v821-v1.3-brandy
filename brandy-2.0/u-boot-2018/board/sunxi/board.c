...
void i2c_init_board(void)
{
	...
	sprintf(fdt_node_str, "twi5");
#elif defined(CONFIG_MACH_SUN50IW10) || defined(CONFIG_MACH_SUN55IW3) || defined(CONFIG_MACH_SUN60IW2) || defined(CONFIG_MACH_SUN65IW1)
...
__weak uint clock_get_pll6(void)
{
	return 0;
}

__weak uint clock_get_mbus(void)
{
	return 0;
}

__weak void aw_board_clk_print(void)
{
	tick_printf(
		"CPU=%d MHz,PLL6=%d Mhz,AHB=%d Mhz, APB1=%dMhz  MBus=%dMhz\n",
