...
#define USBC_Readb(reg)		(*(volatile unsigned char *)((phys_addr_t)reg))
#define USBC_Readw(reg)		(*(volatile unsigned short *)((phys_addr_t)reg))
#define USBC_Readl(reg)		(*(volatile unsigned long *)((phys_addr_t)reg))

#define USBC_Writeb(value, reg)	(*(volatile unsigned char *)((phys_addr_t)reg) = (value))
#define USBC_Writew(value, reg)	(*(volatile unsigned short *)((phys_addr_t)reg) = (value))
#define USBC_Writel(value, reg)	(*(volatile unsigned long *)((phys_addr_t)reg) = (value))
