...
typedef struct {
	...
	defined(CONFIG_MACH_SUN300IW1) || defined(CONFIG_MACH_SUN50IW15) ||	   \
...
#endif
#if defined(CONFIG_MACH_SUN55IW5) || defined(CONFIG_MACH_SUN50IW15)
	unsigned int reserved0[2];
#endif
...
#elif defined(CONFIG_MACH_SUN55IW5) || defined(CONFIG_MACH_SUN50IW15)
	unsigned int reserved1[3];
