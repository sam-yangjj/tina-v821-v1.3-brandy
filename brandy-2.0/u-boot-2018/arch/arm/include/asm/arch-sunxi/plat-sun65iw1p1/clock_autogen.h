...
struct CCMU_st {
	...
	uint32_t cpu_sys_dp_clk_reg;//cpu_sys_dp clock register
	uint32_t pad_until_0x0560[5];
	uint32_t cpux_gic_clk_reg;//cpux_gic clock register
	...
	uint32_t dma0_gar_reg;//dma0 gating and reset register
	...
	uint32_t ce_clk_reg; //ce_sys clock register
	uint32_t ce_bgr_reg; //ce_sys gating and reset register
	...
	uint32_t audiocodec0_adc_clk_reg;//audiocodec0 adc clock register
	uint32_t audiocodec0_gar_reg;//audiocodec0 gating and reset register
	uint32_t audiocodec1_dac_clk_reg;//audiocodec1 dac clock register
	uint32_t pad_until_0x12fc[2];
	uint32_t audiocodec1_gar_reg;//audiocodec1 gating and reset register
	...
	uint32_t hsi_comb0_phy_cfg_clk_reg;//hsi comb0 phy configure clock register
	uint32_t hsi_comb0_phy_ref_clk_reg;//hsi comb0 phy reference clock register
	...
	uint32_t mipi_dsi00_clk_reg;//mipi_dsi00 clock register
	uint32_t mipi_dsi00_gar_reg;//mipi_dsi00 gating and reset register
	uint32_t pad_until_0x15c0[14];
	uint32_t combophy0_clk_reg;//combophy0 clock register
	uint32_t pad_until_0x1600[15];
	uint32_t tcon_tv0_edp_clk_reg;//tcon_tv0_edp clock register
	...
	uint32_t pll_fo0_en_reg;//pll fanout0 enable register
	uint32_t pad_until_0x1a20[3];
	uint32_t pll_opg_bypass_reg;//pll output gate bypass register
	uint32_t pad_until_0x1b00[55];
